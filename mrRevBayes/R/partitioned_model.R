...
#' @param ix int/str - Current partition's index number
#' @keywords mrRevBayes
#' @export
...
#' k80_model_2()
#'
#' Used in partitioned_model() for K80 models
#' @param ix int/str - Current partition's index number
#' @keywords mrRevBayes
#' @export
...
#' hky_model_2()
#'
#' Used in partitioned_model() for HKY models
#' @param ix int/str - Current partition's index number
#' @keywords mrRevBayes
#' @export
...
#' sym_model_2()
#'
#' Used in partitioned_model() for SYM models
#' @param ix int/str - Current partition's index number
#' @keywords mrRevBayes
#' @export
...
#' gtr_model_2()
#'
#' Used in partitioned_model() for GTR models
#' @param ix int/str - Current partition's index number
#' @keywords mrRevBayes
#' @export
...
#' @param subsets_folder path - Relative path to folder that contains nexus subset files
#' @keywords mrRevBayes
#' @export

# * PARTITIONED ANALYSIS
partitioned_model = function(scheme_csv, subsets_folder) {
